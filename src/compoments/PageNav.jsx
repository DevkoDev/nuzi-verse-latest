      ...
      <nav className="navbar py-md-4" style={{ backgroundColor: navBarBGC }}>
        <div className="container-lg d-none d-md-flex">
          <ul className="nav-links">
            <li>
              <Link to="/read" style={{ fontSize: fontSize1, color: "gray", pointerEvents: "none" }}>
                Read
              </Link>
            </li>
            <li>
              <Link to="/watch" style={{ fontSize: fontSize1, color: "gray", pointerEvents: "none" }}>
                Watch
              </Link>
            </li>
            <li>
          ...
          <div className="collapse w-100 p-0 m-0" id="menu" ref={collapseRef}>
            <div className="">
              <ul className="p-0 text-center">
                <li className="my-3">
                  <Link to="/read" style={{ fontSize: "23px", color: "gray", pointerEvents: "none" }}>
                    Read
                  </Link>
                </li>
                <li className="my-3">
                  <Link to="/watch" style={{ fontSize: "23px", color: "gray", pointerEvents: "none" }}>
                    Watch
                  </Link>
                </li>
                <li className="my-3">
                  <Link to="/play" style={{ fontSize: "23px", color: "gray", pointerEvents: "none" }}>
                    Play
                  </Link>
                </li>
                <li className="my-3">
                  <Link to="/marketplace" style={{ fontSize: "23px", color: "gray", pointerEvents: "none" }}>
                    Marketplace
                  </Link>
                </li>
